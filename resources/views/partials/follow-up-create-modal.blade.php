...
>
    ...
    >
        ...
        >
            <h2 class="mb-4 text-base font-semibold text-gray-900 dark:text-white">Create a new follow-up</h2>
            <form method="POST" action="{{ route('follow-ups.store') }}">
                ...
                <div class="mb-3 grid grid-cols-2 gap-3">
                    <div>
                        <label for="new-followup-waiting-on" class="mb-1 block text-xs font-medium text-gray-700 dark:text-gray-300">Waiting on</label>
                        <input
                            id="new-followup-waiting-on"
                            type="text"
                            name="waiting_on"
                ...
                <div class="mb-4 grid grid-cols-2 gap-3">
                    <div>
                        <label for="new-followup-team" class="mb-1 block text-xs font-medium text-gray-700 dark:text-gray-300">Team</label>
                        <select
                            id="new-followup-team"
                    ...
                    <div>
                        <label for="new-followup-member" class="mb-1 block text-xs font-medium text-gray-700 dark:text-gray-300">Team member</label>
                        <select
                            id="new-followup-member"
                            name="team_member_id"
                            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-800 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white/90 dark:focus:border-blue-500"
                        >
