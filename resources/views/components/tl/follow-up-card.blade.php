...
>
    ...
    <div class="flex flex-wrap items-center gap-2">
        <button
            ...
            class="flex items-center gap-1 rounded-lg border border-green-300 bg-green-50 px-2.5 py-1 text-xs font-medium text-green-700 transition hover:bg-green-100 disabled:opacity-50 dark:border-green-700/50 dark:bg-green-500/10 dark:text-green-400 dark:hover:bg-green-500/20"
        >
        ...
        <div class="relative">
            <button
                type="button"
                x-on:click="snoozeOpen = !snoozeOpen"
                x-bind:disabled="isProcessing"
            ...
            <div
                x-show="snoozeOpen"
                x-cloak
                x-on:click.outside="snoozeOpen = false"
                ...
                role="menu"
            >
                @foreach([['label' => '+1 day', 'days' => 1], ['label' => '+3 days', 'days' => 3], ['label' => '+1 week', 'days' => 7]] as $snoozeOption)
                    <button
                        type="button"
                        x-on:click="snooze({{ $snoozeOption['days'] }})"
