...
import { activitySortToggle } from './components/activity-sort-toggle';
...
Alpine.data('activitySortToggle', activitySortToggle as Parameters<typeof Alpine.data>[1]);
...
Alpine.data('shortcutHelp', shortcutHelp as Parameters<typeof Alpine.data>[1]);
