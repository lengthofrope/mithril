...
describe('FollowUp model', function (): void {
    ...
    describe('relationships', function (): void {
        it('belongs to a Task', function (): void {
            $task = Task::create(['title' => 'Parent task']);
            $followUp = FollowUp::create([
                'task_id' => $task->id,
    ...
    describe('scopes', function (): void {
        it('overdue scope returns past non-done follow-ups', function (): void {
            FollowUp::create(['description' => 'Past', 'follow_up_date' => Carbon::yesterday(), 'status' => FollowUpStatus::Open]);
            FollowUp::create(['description' => 'Future', 'follow_up_date' => Carbon::tomorrow(), 'status' => FollowUpStatus::Open]);

            expect(FollowUp::overdue()->count())->toBe(1);
        });

        it('dueToday scope returns today non-done follow-ups', function (): void {
            FollowUp::create(['description' => 'Today', 'follow_up_date' => Carbon::today(), 'status' => FollowUpStatus::Open]);
            FollowUp::create(['description' => 'Tomorrow', 'follow_up_date' => Carbon::tomorrow(), 'status' => FollowUpStatus::Open]);
        ...
        it('dueThisWeek scope returns this-week non-done follow-ups after today', function (): void {
            ...
            FollowUp::create(['description' => 'This week', 'follow_up_date' => $endOfWeek, 'status' => FollowUpStatus::Open]);
            FollowUp::create(['description' => 'Today', 'follow_up_date' => Carbon::today(), 'status' => FollowUpStatus::Open]);
        ...
        it('upcoming scope returns follow-ups after end of week', function (): void {
            ...
            FollowUp::create(['description' => 'Upcoming', 'follow_up_date' => $afterWeek, 'status' => FollowUpStatus::Open]);
            FollowUp::create(['description' => 'This week', 'follow_up_date' => Carbon::now()->endOfWeek(), 'status' => FollowUpStatus::Open]);
