...
describe('AttachmentController', function (): void {
    describe('preview', function (): void {
        it('serves a file inline via signed URL', function (): void {
            Storage::fake('local');
            Storage::disk('local')->put('attachments/2026/03/photo.jpg', 'fake image content');
        ...
        it('returns 403 when signed URL is invalid', function (): void {
            ...
            $response = $this->actingAs($user)->get('/attachments/999/preview');
        ...
        it('returns 404 for attachment belonging to another user', function (): void {
            Storage::fake('local');
            Storage::disk('local')->put('attachments/photo.jpg', 'content');
            ...
            $response = $this->actingAs($other)->get($previewUrl);
