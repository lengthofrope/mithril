 ...
 *
 * Dynamically includes user's teams as submenu items when teams exist.
 */
class MenuHelper
{
    /**
    ...
    /**
     * Build the Teams menu item, dynamically adding teams as sub-items when they exist.
     *
     * @return array<string, mixed>
     */
    private static function buildTeamsItem(): array
    {
        ...
        $subItems = [['name' => 'All Teams', 'path' => '/teams']];

        foreach ($teams as $team) {
            $subItems[] = ['name' => $team->name, 'path' => '/teams/' . $team->id];
        }
    ...
    /**
     * Return the menu groups for the sidebar.
     *
     * @return array<int, array<string, mixed>>
     */
    ...
    /**
     * Check if the given path matches the current request.
     *
     * @param string $path
     * @return bool
     */
